...
export default function AboutUs() {
  return (
    ...
    //         personalised tuition, we understand that every student is unique, and so is their learning style.
    //         <br></br> <br></br>
    //         Our exceptional educators specialise in catering to diverse pupil needs and groups, including those with Special Educational Needs (SEN),
    //         Looked After Children (LAC), and Alternative Provision (AP). Through tailored support and personalised attention, we empower each student to progress confidently, maximizing their
      ...
      <div class="row">
        <div class="about-col">
          ...
          <p>
            ...
            academic journey of primary and secondary school students in London.
            With a focus on personalized tuition, we understand that every
            student is unique, and so is their learning style.
            <br></br> <br></br>
            Our exceptional educators specialize in catering to diverse pupil
            ...
            Through tailored support and personalized attention, we empower each
